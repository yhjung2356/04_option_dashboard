...
public class OptionData {
    ...
    @Column
    private BigDecimal theoreticalPrice; // 이론가

    @Column
    private BigDecimal intrinsicValue; // 내재가치

    @Column
    private BigDecimal timeValue; // 시간가치

    @Column
    private Long openInterestChange; // 미결제 증감
